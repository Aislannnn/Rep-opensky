...
SUPABASE_KEY = "sb_publishable_iWsQ3dxCc8S2gcnDzS1z5w_zbiX8Py_"
...
def enviar_supabase(icao: str, chegadas: list, partidas: list) -> None:
    """Insere chegadas e partidas no Supabase para o aeroporto informado."""
    voos = []
    for voo in chegadas + partidas:
        voo["airport_icao"] = icao
        voos.append(voo)
    ...
    try:
        supabase.table("voos").insert(voos).execute()
